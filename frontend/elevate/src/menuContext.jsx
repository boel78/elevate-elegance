...
export const MenuContextProvider = (props) => {
    ...
    const contextValue = {sideMenuActive, setSideMenuActive, filteredProducts, setFilteredProducts, cart, setCart, currentUser, setCurrentUser, setCartMenuActive, cartMenuActive}
  return (
