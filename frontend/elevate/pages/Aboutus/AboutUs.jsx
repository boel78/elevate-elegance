...
export const AboutUs = () => {
  ...
  return (
    <Layout>
      <div className="flex flex-col items-center pt-20 gap-28 sm:px-20">
        ...
        <div className="flex gap-12">
          ...
          <div className="sm:w-1/3 flex flex-col gap-5">
            <div className="flex">
              <h3 className="font-medium leading-normal text-center sm:text-left text-3xl">Elevate Elegance</h3>
              <img
            src="https://plus.unsplash.com/premium_photo-1674718916916-60f009b8e00c?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            className="w-1/2 sm:hidden pr-5"
          />
            </div>
            <p className="text-lg px-5 sm:px-0">
        ...
        <div className="flex gap-12">
          <div className="sm:w-1/3 flex flex-col gap-5">
            ...
            className="w-1/2 block sm:hidden pl-5"
          />
              <h3 className="font-medium text-2xl sm:text-left text-center w-full pt-2 sm:pt-0">Our Story</h3>
        ...
        <div className="flex gap-12">
          ...
          <div className="sm:w-1/3 flex flex-col gap-5">
            <div className="flex">
              <h3 className="font-medium text-2xl text-center sm:text-left">Quality and Craftmanship</h3>
              <img
            src="https://plus.unsplash.com/premium_photo-1664304041357-9ee3070abe68?q=80&w=1169&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            className="w-1/2 block sm:hidden pr-5"
          />
              </div>
        ...
        <div className="flex gap-12">
          <div className="sm:w-1/3 flex flex-col gap-5">
            ...
            className="w-1/2 block sm:hidden pl-5"
          />
              <h3 className="font-medium text-2xl w-full text-center pt-2 sm:pt-0">Our Promise</h3>
              </div>
        ...
        <div className="flex flex-col items-center sm:w-2/3 gap-4 pb-20">
