...
export const Search = () => {
  ...
  return (
    <div className="flex flex-col fixed right-0 top-12 w-2/3 sm:w-1/4 bg-white h-1/2 border-l-2 border-b-2 border-black font-inter shadow-md rounded-b-md pt-14 gap-10">
